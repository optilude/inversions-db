...
@media (max-width: 600px) {
  ...
  .ctrl-group { display: grid; grid-template-columns: 85px 1fr; }
  select#chord-type, select#group-by { min-width: 0; width: 100%; box-sizing: border-box; }
  #annotation-btns, #string-filters { display: flex; width: 100%; }
  .ann-btn, .str-btn { flex: 1; }
}
...
let groupByMode       = 'inversion';  // 'inversion' | 'string_set' | 'none'
